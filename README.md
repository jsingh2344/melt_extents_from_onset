...
- Main issue was loading enough images from the datacube into memory at the same time to run functions on. Google Colab memory goose chase was not fruitful. Currently chunking the datacube into 500x500 pixel sections, which equate to ~450 MB each.
